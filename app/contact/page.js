...
const CONTACT_METHODS = [
  {
    icon: "📧",
    label: "Email",
    value: "info@yachtdrop.com",
    href: "mailto:info@yachtdrop.com",
  },
  {
    icon: "📞",
    label: "Phone",
    value: "+34 662 542 872",
    href: "tel:+34662542872",
  },
  {
    icon: "📍",
    label: "Address",
    value: "Av. Tomàs Blanes Tolosa, 41, 07181 Costa d'en Blanes, Illes Balears",
    href: "https://maps.google.com/?q=Av.+Tomàs+Blanes+Tolosa+41+Costa+d'en+Blanes",
  },
];
...
const SOCIALS = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/yachtdrop/",
    svg: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/yachtdrop",
    svg: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/yachtdrop",
    svg: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "X (Twitter)",
    href: "https://www.twitter.com/yachtdrop",
    svg: (
